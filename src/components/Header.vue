<template>
    <header class="flex justify-between items-center p-4 bg-transparent text-white w-full absolute z-100">
        ...
        <nav :class="['nav-menu, z-40', { 'hidden': !showMobileMenu }]" 
             class="flex gap-5 mr-4 text-[14px] md:flex md:relative md:bg-transparent md:text-white absolute top-0 left-0 w-full bg-white text-black bg-opacity-90 flex-col items-center z-50 md:flex-row md:items-center md:w-auto justify-center">
